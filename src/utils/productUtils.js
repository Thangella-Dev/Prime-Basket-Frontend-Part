...
const CATEGORY_IMAGE_FALLBACKS = {
  rice: "/assets/rice-pack.svg",
  oil: "/assets/olive-oil.png",
  "wheat-flour": "/assets/grocery-items.png",
  salt: "/assets/grocery-items.png",
  sugar: "/assets/grocery-items.png",
  "chilli-powder": "/assets/spice-jar.svg",
  "turmeric-powder": "/assets/spice-jar.svg",
  pulses: "/assets/pulses-bowl.svg",
  masala: "/assets/spice-jar.svg",
  fruits: "/assets/fruits.png",
  vegetables: "/assets/groceries-and-vegetables.png",
  dairyProducts: "/assets/dairy-needs.png",
  feminineHygiene: "/assets/feminine-care.svg",
  homeNeeds: "/assets/home-needs.svg",
  babyCare: "/assets/baby-care.svg",
  instantFood: "/assets/snack-pack.svg",
  milkPowders: "/assets/milk.png",
  chipsAndNamkeens: "/assets/snack-pack.svg",
  oralCare: "/assets/oral-care.svg",
  biscuitsAndCookies: "/assets/biscuit-pack.svg",
  coolDrinks: "/assets/cool-drink.svg",
  bodyCare: "/assets/body-care.svg",
...
const PRODUCT_IMAGE_RULES = [
  ...
  { match: /(chilli|chili powder)/i, image: "/assets/spice-jar.svg" },
  { match: /(turmeric|haldi)/i, image: "/assets/spice-jar.svg" },
  { match: /(dal|grams|peas|beans|rajma|moong|toor|masoor|pulses)/i, image: "/assets/pulses-bowl.svg" },
  { match: /(masala|spice|seasoning|curry powder|garam)/i, image: "/assets/spice-jar.svg" },
  ...
  { match: /(pads|tampons|feminine|whisper|sofy)/i, image: "/assets/feminine-care.svg" },
  { match: /(wipes|mee mee|pampers|baby care|diapers)/i, image: "/assets/baby-care.svg" },
  { match: /(surf excel|vim|dishwash|detergent|cleaner|liquid wash|home needs)/i, image: "/assets/home-needs.svg" },
  { match: /(maggi|yippee|noodles|instant food)/i, image: "/assets/snack-pack.svg" },
  { match: /(milk powder|amulya|nestle everyday|powder)/i, image: "/assets/milk.png" },
  { match: /(bhujia|mad angles|chips|namkeen|crisps|snacks)/i, image: "/assets/snack-pack.svg" },
  { match: /(toothpaste|toothbrush|oral-b|colgate|dental|miswak)/i, image: "/assets/oral-care.svg" },
  { match: /(soap|body wash|lotion|shampoo|conditioner|santoor|dove|vaseline|dettol)/i, image: "/assets/body-care.svg" },
